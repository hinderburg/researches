  ...
  const UI = {
    ...
    showIntro(manual) {
      ...
      const ov = this.overlay(`<div class="intro">
        ...
        <div class="intro-item">${ic('fortify')}<div><b>Castles.</b> Each side starts in a castle. Its defence is 16 + 1 per hex you hold + 2 per outpost + 4 for the Citadel, and it rises or sinks as your land grows or shrinks. Attack it by stepping onto it: every point of damage burns one of its owner's hexes, farthest first, and the castle strikes back at once. If the attacker still outnumbers its defence after both hits, it marches in — the castle falls and the match is over. A warband inside defends it and never falls back.</div></div>
