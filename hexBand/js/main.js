...
(function () {
  ...
  const UI = {
    ...
    updateForecast(ctx) {
      ...
      let fc = null;
      if (ctx.valid && ctx.choice && ctx.choice.path && ctx.choice.path.some(c => c.attack)) fc = R.forecast(s, p, enemy, 'clash', ctx.def.charge || 0);
