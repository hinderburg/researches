  ...
  const UI = {
    ...
    showIntro(manual) {
      ...
      const ov = this.overlay(`<div class="intro">
        ...
        <div class="intro-item">${ic('battle_cry')}<div><b>Бейте с выгодной стороны.</b> Если после вашей карты противник стоит рядом перед отрядом — удар (один за ход). Отряд смотрит туда, куда шёл: во фланг больнее, в спину — ещё больнее.</div></div>
